...
UIView *customToast = nil;

#pragma mark - Toast Methods

- (void)makeCustomToast:(NSString *)message duration:(NSTimeInterval)duration image:(UIImage *)image position:(id)position {
    if (customToast != nil)
    {
        [self hideToast:customToast];
    }
    customToast = [self viewForMessage:message title:nil image:image];
    [self showToast:customToast duration:duration position:position];
}
